      ...
      <div className="relative z-[1] w-full max-w-2xl space-y-8">
        ...
        <div className="text-center">
          <Link href="/" className="inline-flex items-center justify-center gap-3 mb-6">
            <Image src="/brand/1-transparent.png" alt="Mugdm" width={140} height={40} className="hidden h-10 w-auto dark:block" />
            <Image src="/brand/2-transparent.png" alt="Mugdm" width={140} height={40} className="h-10 w-auto dark:hidden" />
          </Link>
        </div>
