...
import BulkBillUpload from '@/components/bookkeeper/BulkBillUpload'
...
export default async function BulkBillUploadPage({ params }: PageProps) {
  ...
  return <BulkBillUpload businessId={biz.id} />
}
