  ...
  return (
    <footer className="relative border-t border-border bg-surface-1/30 overflow-hidden">
      ...
      <div
        ...
        style={{
          background: "url('/brand/7-transparent.png') no-repeat center/contain",
        }}
      />
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          ...
          <a href="#" className="flex items-center group">
            <Image
              ...
              width={200}
              height={60}
              className="hidden h-[60px] w-auto transition-transform duration-300 group-hover:scale-105 dark:block"
            />
            <Image
              ...
              width={200}
              height={60}
              className="h-[60px] w-auto transition-transform duration-300 group-hover:scale-105 dark:hidden"
            />
          </a>
